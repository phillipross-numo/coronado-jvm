...
interface CardPrograms {
    ...
    fun listCardProgramsByExternalCardProgramId(cardProgramExternalId: String) // listCardPrograms GET /partner/card-programs
    fun listCardProgramsByExternalPublisherId(publisherExternalId: String) // listCardPrograms GET /partner/card-programs
}
